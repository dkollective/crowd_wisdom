...
#     def create_event_section(event_name):
#         return {
#             "type": "section",
#             "text": {
#                 "type": "mrkdwn",
...
#                     "emoji": true
#                 },
#                 "options": create_choices(event_name)
#             }
#         }
...
#                 }
#             ] +
#             [create_event_section(po) for po in poss_outcomes] +
#             [
#                 {
#                     "type": "divider"
#                 }
...
#             self, trigger_id, prediction_name='FIRST_ROUND_RESULT'):
#         message = self.create_question(question, poss_outcomes)
#         self.team.api_call(
#             "chat.postEphemeral",
#             text=message
#             user=self.user_id,
...
class GroupPrediction:
    ...
    def start_first_round(self):
        blocks = self.create_question('Which pill will he take?', ['Blue', 'Red'])
        self.team.api_call(
            "chat.postMessage",
            blocks=blocks
            user=self.user_id,
